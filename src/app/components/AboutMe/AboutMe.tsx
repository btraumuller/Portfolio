    ...
    if (aboutMeData){
        return(
            <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row px-4 lg:px-0">
                <div className="self-center lg:self-auto rounded-[50%] z-10 overflow-hidden mb-8 lg:mb-0 lg:mr-[4rem] profile-border w-full  max-w-[300px] lg:max-w-[500px] lg:animate-about__Image">
